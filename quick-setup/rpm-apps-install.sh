...
echo "INSTALLING GNOME TWEAKS, ALACRITTY, HTOP, GTHUMB, SOLAAR, NVIM, AUTOJUMP HUGO TRASH"
sudo dnf install -y gnome-tweaks alacritty htop gthumb solaar nvim autojump hugo trash-cli
echo ""
